Pod::Spec.new do |s|
  ...
  s.ios.source_files = 'common/include/*.h', 'ios/include/*.h', 'ios/src/arm/*.{c,S}', 'ios/src/x86/*.{c,S}', 'ios/src/{closures,debug,prep_cif,raw_api,types}.c'
  s.osx.preserve_paths = 'osx/src/dlmalloc.c'
  s.osx.source_files = 'common/include/*.h', 'osx/include/*.h', 'osx/src/x86/*.{c,S}', 'osx/src/{closures,debug,prep_cif,raw_api,types}.c'
